...
{	
  ...
  packageListServers = new PackageListLocal(listViewPackages,tr("feeds"));
  packageListSearch = new PackageListRemote(listViewPackages,tr("ipkgfind&killefiz"));
  packageListDocLnk = new PackageListDocLnk(listViewPackages,tr("documents"));
