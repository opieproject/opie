 ...
 *
 * $Id: devices.cpp,v 1.1.2.1 2003-07-30 17:54:23 tille Exp $
 *
...
DevicesWidget::DevicesWidget( InterfacePPP* ip, QWidget *parent, const char *name )
    : ChooserWidget(ip->data(), parent, name)
{
  _ifaceppp = ip;
