...
CONFIG_SPECFILE="qws/linux-generic-g++"
# CONFIG_CUSTOMFILE is not set
# CONFIG_OPTIMIZATIONS is not set
...
CONFIG_HOMEAPPLET=y
CONFIG_IRDAAPPLET=y
CONFIG_LOGOUTAPPLET=y
CONFIG_OBEX=y
CONFIG_ROTATEAPPLET=y
CONFIG_SCREENSHOTAPPLET=y
CONFIG_SUSPENDAPPLET=y
CONFIG_VMEMO=y
CONFIG_VOLUMEAPPLET=y

#
# Network applet needs a libqpe and libopie2 (core, ui, net)
#
CONFIG_NOTESAPPLET=y
CONFIG_WIRELESSAPPLET=y

#
# Apps
#
CONFIG_CALIBRATE=y
CONFIG_EMBEDDEDKONSOLE=y
...
CONFIG_CONFEDIT=y
CONFIG_ODICT=y
CONFIG_OPIE-CONSOLE=y
CONFIG_OPIE-READER=y
CONFIG_OPIE-SHEET=y
CONFIG_OPIE-WRITE=y
CONFIG_OXYGEN=y
CONFIG_SYSINFO=y
...
CONFIG_OPIEIRC=y
CONFIG_OPIETOOTH=y
CONFIG_OPIETOOTH-APPLET=y
CONFIG_BLUE-PIN=y
CONFIG_LIBOPIETOOTH=y
CONFIG_OPIETOOTH-MANAGER=y
CONFIG_UBROWSER=y
...
#
# sfcave-sdl (warning: requires libsdl)
#
...
CONFIG_WAVPLUGIN=y
CONFIG_LIBTREMOR=y
CONFIG_LIBTREMORPLUGIN=y

#
# tremor is ogg vorbis!!
#

#
# opie-camera needs a libqpe, libopie and libopie2core
#
CONFIG_OPIEPLAYER2=y
CONFIG_OPIEREC=y
CONFIG_SHOWIMG=y
...
# Today Plugins
#
CONFIG_TODAY_FORTUNE=y
CONFIG_TODAY_STOCKTICKER=y
CONFIG_TODAY_STOCKTICKERSUB=y
CONFIG_TODAY_STOCKTICKERLIB=y
CONFIG_TODAY_WEATHER=y
...
CONFIG_NETWORKSETUP=y
CONFIG_NETWORKSETUP-CORE=y
CONFIG_PPP=y
CONFIG_WLAN=y
CONFIG_INTERFACES=y
CONFIG_SOUND=y
