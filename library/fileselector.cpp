...
public:
	...
	setPixmap( 0, Resource::loadPixmap( "new" ) );
    }
...
/*!
  If \a b is TRUE a "new document" button is visible; if \a b is FALSE
  this button is not visible and the user is unable to create new
