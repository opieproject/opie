...
#ifndef _OMEMOACCESSBACKEND_H_
#define _OMEMOACCESSBACKEND_H_
 ...
 *
 * @see OPimMemoAccessBackend_VCard  // FIXME
 * @see OPimMemoAccessBackend_XML
 */
class OPimMemoAccessBackend: public OPimAccessBackend<OPimMemo> {
 public:
     ...
     */
    UIDArray queryByExample( const UIDArray& uidlist, const OPimMemo&, int settings, const QDateTime &d = QDateTime() ) const;
    /**
